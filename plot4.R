plot4 <- function (){
    ...
    #plot 4.3
    plot(pcons$Time, pcons$Voltage, type = "n", xlab = "datetime", ylab = "Voltage", 
         font = 2, font.lab = 2)
    lines(pcons$Time, pcons$Voltage)
    
    #plot 4.4
    plot(pcons$Time, pcons$Global_reactive_power, type = "n", xlab = "datetime", 
         ylab = "Global_reactive_power", font = 2, font.lab = 2, col = "grey35")
    lines(pcons$Time, pcons$Global_reactive_power)
